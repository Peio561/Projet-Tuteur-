<?php
  ...
  $role=$_SESSION['role'];
  $_SESSION['jeu']='league of legends';

  $res=get_equipes('league of legends');
  ...
  $res=get_matchs('league of legends');
  $match="";
  ...
  $res=get_paris('league of legends');
  $paris="";
  foreach($res as $row) {
